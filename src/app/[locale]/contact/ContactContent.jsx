    ...
    <div>
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-md text-center border border-M-text-color/20 hover:border-M-primary-color/80 transition-all duration-300 group">
            ...
            <h3 className="text-2xl sm:text-3xl text-black mb-2">{content.locationTitle?.trim() || "Location"}</h3>
            <p className="text-base text-M-text-color font-jost font-normal hover:text-M-primary-color">
              {content.locationText?.trim() || "Race Course, Sasongacha, Cumilla – 3500"}
            </p>
          </div>
          <div className="bg-white p-6 rounded-md text-center border border-M-text-color/20 hover:border-M-primary-color/80 transition-all duration-300 group">
            <div className="size-20 flex items-center justify-center bg-M-section-bg rounded-full mx-auto mb-4">
            ...
            <h3 className="text-2xl sm:text-3xl text-black mb-2">{content.emailTitle?.trim() || "Email Address"}</h3>
            <Link href={`mailto:${content.emailAddress?.trim() || "info@muktihospital.com"}`} className="text-base text-M-text-color font-jost font-normal hover:text-M-primary-color">
              {content.emailAddress?.trim() || "info@muktihospital.com"}
            </Link>
          </div>
          <div className="bg-white p-6 rounded-md text-center border border-M-text-color/20 hover:border-M-primary-color/80 transition-all duration-300 group">
            <div className="size-20 flex items-center justify-center bg-M-section-bg rounded-full mx-auto mb-4">
            ...
            <h3 className="text-2xl sm:text-3xl text-black mb-2">{content.hoursTitle?.trim() || "Opening Hours"}</h3>
            <p className="text-base text-M-text-color font-jost font-normal whitespace-pre-line">
              {content.hoursText?.trim() || "Saturday - Thursday\n09:00 AM - 05:00 PM"}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container pt-10 pb-24 h-[400px] lg:h-[800px]">
        <iframe
          ...
          src={content.mapUrl?.trim() || "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4341.297409567763!2d91.1663045753272!3d23.46614927886534!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x37547ed6b4ea44f7%3A0x6295ef461f485724!2z4Kau4KeB4KaV4KeN4Kak4Ka_IOCmueCmvuCmuOCmquCmvuCmpOCmvuCmsiDgpofgpq7gpr7gprDgp43gppzgp4fgpqjgp43gprjgpr8!5e1!3m2!1sen!2sbd!4v1741599583103!5m2!1sen!2sbd"}
          allowFullScreen=""
          loading="lazy"
