        ...
        <div className="pt-[80px] lg:pt-[100px] pb-20 md:pb-32 lg:pb-[120px] px-3 bg-gradient-to-t from-[#009650be] to-[#323290be] relative">
          ...
          <div className="container mx-auto text-center">
            <ul className="gap-6 flex flex-wrap items-center justify-center mb-4 ">
                <li><Link href={'/'} className="font-jost font-medium leading-4 tracking-wider text-base text-white block uppercase relative before:w-2 before:h-[2px] before:bg-white before:absolute before:-right-4 before:top-1/2 before:-translate-y-1/2">Home</Link></li>
                <li className="font-jost font-medium leading-4 tracking-wider text-base text-white block uppercase">Doctors List</li>
            </ul>
