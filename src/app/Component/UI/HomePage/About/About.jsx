...
// // This will be fetched at build time for static rendering
// export async function getStaticProps() {
//   return {
//     props: {},  // No dynamic data, just static content
//   };
// }
...
//         />
//         <p>
//           We provide the special tips and advice’s of health care treatment and
//           high level of best technology involved in our hospital. We provide
//           the special tips and advice’s of health care treatment.
//         </p>
...
export async function getStaticProps() {
  ...
  return {
    props: {
      reviews,  // Pass the fetched reviews to the About page component
    },
...
const About = ({ reviews }) => {
  return (
    <div>
      <h1>About Us</h1>
      <div>
        {/* You can render the reviews here */}
