// Testimonials.jsx (FIXED)

'use client';
// 🔴 useState, useEffect, fetchReviews ইম্পোর্ট বাদ দিন
...
// ✅ FIX: 'reviews' prop-এর জন্য default value হিসেবে একটি খালি অ্যারে ([]) সেট করা হয়েছে।
const Testimonials = ({ reviews = [] }) => {
  const { t } = useTranslation();
  // 🔴 'reviewsState' এবং 'useEffect' পোলিং বাদ দিন
    ...
    <div className="py-12 lg:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-10">
          ...
          >
            {/* ✅ 'reviews' prop এখন ডিফল্ট [] হওয়ায় নিরাপদ */}
            {reviews.length === 0 ? (
              ...
              // ✅ 'reviewsState'-এর বদলে 'reviews' prop ম্যাপ করুন
              reviews.map((review) => { 
