...
//         {isFilterOpen && (
//           <div className="space-y-8 fixed md:relative bg-white top-0 left-0 w-full overflow-y-scroll md:overflow-y-auto h-screen md:h-auto px-2 py-2 md:p-0">
//             {/* CTA Start */}
...
const DoctorsList = ({ doctors }) => {
  ...
  // ✅ Extract unique specialties & genders based on current language
  const specialtyOptions = [
    ...new Set(doctors.map((d) => d.translations[currentLanguage]?.department)),
