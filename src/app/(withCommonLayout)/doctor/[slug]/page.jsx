      ...
      <div className="container pb-24 relative -mt-24 z-50">
        <div className="grid grid-cols-4 gap-6">
          <div className="col-span-3">
            ...
            {/* Short Bio */}
            <div
              className="bg-white px-7 rounded-md mt-6 border border-M-heading-color/10"
              id="shortBio"
            >
              <div
            ...
            >
              ...
              >
                <p className="text-M-text-color text-base font-normal font-jost">
                  ...
                  awards and honors. Dr. Johnson’s exceptional contributions to
                  medicine and patient care have been widely recognized through
            ...
            >
              ...
              <div
                className={`space-y-5 transition-all duration-300 overflow-hidden ${
                  openSections.followUpFee ? "max-h-auto py-5" : "max-h-0 py-0"
                }`}
              >
                <p className="text-M-text-color text-base font-normal font-jost">
                  Dr. Johnson’s exceptional contributions to medicine and
            ...
            >
              ...
              >
                ...
                <Icon
                  ...
                  height="24"
                  className={`transition-all duration-300 ${
                    openSections.avgConsultationTime ? "rotate-180" : "rotate-0"
                  }`}
                />
              </div>
              <div
              ...
              >
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h5 className="text-M-heading-color text-lg font-semibold font-jost">
                ...
                <div className="space-y-5">
                  {faqData.map((item, index) => (
                    ...
                    >
                      {/* Accordion Header */}
                      <h4
                        className="w-full flex items-start justify-between gap-5 cursor-pointer font-bold text-lg bg-M-heading-color text-white p-4"
          ...
          <div className="space-y-8">
            <div className="bg-M-heading-color p-6 px-6 rounded-md">
              ...
              <div className="pt-5 mt-5 border-t border-M-primary-color/20">
                <h3 className="text-white text-xl font-semibold mb-3">Contact For Serial</h3>
                <Link href={'tel:+8801601666893'} className="flex items-center gap-3 justify-center py-3 px-3 rounded-md bg-M-primary-color border border-M-primary-color text-white text-base font-jost font-medium w-full transition-all duration-300 hover:bg-M-heading-color"> <Image src={callIcon} alt="phone Icon" /> +880 1601 666-893</Link>
              </div>
            </div>
            <div className="border border-M-heading-color/20 p-6 px-6 rounded-md">
              ...
              <div>
                <ul className="py-4">
                  <li className="p-3 border border-M-heading-color/20 inline-block rounded font-jost bg-M-text-color/10 transition-all duration-300 hover:bg-M-heading-color hover:text-white">8.30:AM - 4:30 PM</li>
                </ul>
                <Link href={'tel:+8801601666893'} className="flex items-center gap-3 justify-center py-3 px-3 rounded-md bg-M-primary-color border border-M-primary-color text-white text-base font-jost font-medium w-full transition-all duration-300 hover:bg-M-heading-color uppercase">Book Appointment</Link>
              </div>
            </div>
          </div>
        </div>
